...
namespace SK.Libretro.Unity
{
    ...
    ""controlSchemes"": [
        ...
        private List<IEmulationActions> m_EmulationActionsCallbackInterfaces = new List<IEmulationActions>();
        ...
        public struct EmulationActions
        {
            ...
            public void AddCallbacks(IEmulationActions instance)
            {
                if (instance == null || m_Wrapper.m_EmulationActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_EmulationActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IEmulationActions instance)
            {
                @DPadUp.started -= instance.OnDPadUp;
                @DPadUp.performed -= instance.OnDPadUp;
                @DPadUp.canceled -= instance.OnDPadUp;
            ...
            public void RemoveCallbacks(IEmulationActions instance)
            {
                if (m_Wrapper.m_EmulationActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IEmulationActions instance)
            {
                foreach (var item in m_Wrapper.m_EmulationActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_EmulationActionsCallbackInterfaces.Clear();
